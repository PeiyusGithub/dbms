...
public:
    ...
    RC loadIndex(vector<string> indexFileNames, const string index_name);

    RC decodeIndex(const void* data, vector<Attribute> attrs, const string attName, void* key);

    RC getIndex(vector<string> indexFileNames, const string index_name);
